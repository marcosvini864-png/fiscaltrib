...
export default function Relatorio({ active, ents }) {
  ...
  function gerarPDF() {
    ...
    for (let i = 1; i <= totalPages; i++) {
      ...
      doc.setTextColor(255, 255, 255)
      doc.setFont('helvetica', 'bold')
      doc.text('FiscalTrib', W / 2, pH - 9, { align: 'center' })
      doc.setFont('helvetica', 'normal')
      doc.setFontSize(7.5)
      doc.text('| Sistema de Diagnóstico e Recuperação Tributária |', W / 2, pH - 5.5, { align: 'center' })
      doc.text(`Tel: (11) 5589-2614  |  WhatsApp: (11) 99957-9822  |  fiscaltrib.com.br`, W / 2, pH - 2, { align: 'center' })
      doc.text(`Página ${i} de ${totalPages}`, W - 14, pH - 5, { align: 'right' })
    }
