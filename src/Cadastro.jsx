...
const st = {
  ...
  card:       { background: '#1e293b', borderRadius: 16, padding: '28px 36px', width: '100%', maxWidth: 460, boxShadow: '0 8px 32px rgba(0,0,0,0.4)' },
  ...
  checklist:  { listStyle: 'none', padding: 0, margin: '5px 0 0', fontSize: 12, display: 'flex', flexDirection: 'column', gap: 2 },
  ...
  seguranca:  { color: '#64748b', fontSize: 12, textAlign: 'center', marginBottom: 12, lineHeight: 1.4 },
  btn:        { width: '100%', padding: 11, background: '#3b82f6', color: '#fff', border: 'none', borderRadius: 8, fontWeight: 700, fontSize: 15, cursor: 'pointer', marginBottom: 10 },
  btnVoltar:  { width: '100%', padding: 8, background: 'transparent', color: '#94a3b8', border: '1px solid #334155', borderRadius: 8, cursor: 'pointer', fontSize: 14 },
}