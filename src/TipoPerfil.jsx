export default function TipoPerfil({ onEscolher }) {
  const perfis = [
    {
      id: 'contador',
      icone: '📊',
      titulo: 'Contador',
      descricao: 'Escritório de contabilidade ou contador autônomo',
    },
    {
      id: 'advogado',
      icone: '⚖️',
      titulo: 'Advogado',
      descricao: 'Advogado tributarista ou escritório jurídico',
    },
    {
      id: 'empresario',
      icone: '🏢',
      titulo: 'Empresário',
      descricao: 'Proprietário ou gestor de empresa',
    },
  ]
